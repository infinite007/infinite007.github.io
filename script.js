function loadContent(section) {
    ...
    switch(section) {
        case 'home':
            ...
            break;
        case 'resume':
            contentDiv.innerHTML = `<h1>Resume</h1><p>Details of your professional experience and education.</p>`;
            break;
        case 'projects':
            contentDiv.innerHTML = `<h1>Projects</h1><p>Details of your projects.</p>`;
            break;
        case 'skills':
            contentDiv.innerHTML = `<h1>Skills</h1><p>Details of your skills.</p>`;
            break;
        case 'contact':
